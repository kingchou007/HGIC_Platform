...
class TaskControl(object):
    ...
    def circle_search(self):
        ...
        self.control.set_parameters(v_max=10, r_max=20, k_mig=0.5, k_rep=25, k_sep=0.3, k_coh=0.02)
    ...
    def line_search(self):
        ...
        self.control.set_parameters(v_max=20, r_max=25, k_mig=0.08, k_rep=25, k_sep=1, k_coh=0.1)
